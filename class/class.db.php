...
class db
{
	...
	public function setup(){
		...
		$sqlQuery=$bdd->prepare("CREATE TABLE \"tblLanguage\" (
		...
		INSERT INTO `tblLanguage` VALUES ('4','C++','cpp','0','1');
		INSERT INTO `tblLanguage` VALUES ('5','AppleScript','applescript','0','1');
		INSERT INTO `tblLanguage` VALUES ('6','ActionScript 3','as3','0','1');
